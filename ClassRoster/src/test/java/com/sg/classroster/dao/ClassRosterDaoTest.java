...
public class ClassRosterDaoTest {
    ...
    public void setUp() throws Exception {
        //remove all students in the file before a test method runs
    ...
    public void testAddGetStudent() throws Exception {
        //add student using Dao, get back and compare
    ...
    public void testRemoveStudent() throws Exception {
        //add two students, remove one, remove the other
        Student student1 = new Student("0001");
        student1.setFirstName("Joe");
        student1.setLastName("Smith");
        student1.setCohort("Java-May-2017");
